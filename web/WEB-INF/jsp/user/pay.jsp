  ...
  <jsp:include page="../head_n.jsp"></jsp:include>
    <div id="head">
    	<div id="c_head">
    		<div id="head_left">
    			<ul>
    				<li class="head_left_li2"><span>我&nbsp;的&nbsp;收&nbsp;银&nbsp;台</span></li>
    			</ul>
    		</div>
    		<div id="head_right">
    			<ul>
    ...
    <div id="con">
    	<div id="c_con">
    			...
    			<c:forEach items="${order.orderProducts }" var="op">
	    			...
	    			<div class="con_up_2">
	    				<span class="con_up_2_s1">
	    					<fmt:formatNumber type="number" value="${op.product.price * op.product.discount * op.buynum }" groupingUsed="false"></fmt:formatNumber>
	    				</span>
    		...
    		<div id="con_down">
    			<form action="order?method=payment" method="post" id="form">
